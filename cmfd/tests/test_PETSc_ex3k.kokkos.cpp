...
int mainTest()
{
  ...
  */
  ...
  PetscCall(DMSetVecType(ctx.da, VECKOKKOS));
  PetscCall(DMSetMatType(ctx.da, MATAIJKOKKOS));
  ...
  */
  ...
  EXPECT_LT(norm, 1e-6) << "Norm of error is too large, check the implementation of the KokkosFunction";
