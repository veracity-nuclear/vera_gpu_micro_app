...
TEST(BasicTest, pin_7g_16a_3p_serial_single) {
    const char* raw_args[] = {"exe", "data/pin_7g_16a_3p_serial.h5", "data/c5g7.xsl", "--precision", "single"};
    ...
    solver.solve();
    EXPECT_NEAR(solver.keff(), 1.325693714, 1.0e-7);
}
