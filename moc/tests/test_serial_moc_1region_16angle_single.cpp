...
TEST(BasicTest, cart_1region_7g_16a_3p_serial_single) {
    const char* raw_args[] = {"exe", "data/cart_1region_7g_16a_3p_serial.h5", "data/c5g7.xsl", "--precision", "single"};
    ...
    solver.solve();
    EXPECT_NEAR(solver.keff(), 0.738222100, 5.0e-6);
}
