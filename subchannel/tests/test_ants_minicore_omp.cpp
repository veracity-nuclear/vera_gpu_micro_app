...
TEST(SubchannelTest, Minicore_OpenMP) {
    ...
    Kokkos::View<size_t**, Kokkos::OpenMP> core_map("core_map", map.size(), map[0].size());
    ...
    Kokkos::View<double*, Kokkos::OpenMP> inlet_temperature("inlet_temperature", geometry.nchannels());
    Kokkos::View<double*, Kokkos::OpenMP> inlet_pressure("inlet_pressure", geometry.nchannels());
    Kokkos::View<double*, Kokkos::OpenMP> linear_heat_rate("linear_heat_rate", geometry.nchannels());
